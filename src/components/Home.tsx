...
const Home = () => {
  return (
    <Card>
      <CardMedia component="img" src={Banner} alt="Vipul Sharma" className="card-media" />
      <CardHeader
        title={
            ...
            <Grid item xs={12} md={6}>
              <Paper className="about-me-paper">
                <Stack direction="column" spacing={2}>
                  ...
                  <Typography variant="body1">
                    🌍 Embracing Open Source: Open source taught me the joy of contributing. Being a Google Code-in finalist in 2013 was a milestone.
                  </Typography>
                  <Typography variant="body1">
                    💡 Logical Thinking and Growth: Programming refined my logical thinking and problem-solving skills. It defines me.
                  </Typography>
